public class logicChessData
{
    ...
    public static string[] Case2 = {
        ...
        "*b.|(Missing a Forget Me Not stage? This it quite unusual given how often he defuses.)",
        ...
        "-w,|I'm sorry but last time I checked, missing a stage is acceptable. I must figure out what went wrong.",
    ...
    public static string[] Case4 = {
        ...
        "-w.|For flavors on the module, we have Tutti Fruitti, Raspberry Ripple, Double Strawberry, The Classic, and--",
    ...
    public static string[] Case5 = {
        ...
        "*w.|Can you tell me exactly what occured?",
        "-w.|Sure thing, sir.",
    ...
    public static string[] Case6 = {
        ...
        "-w.|Adding the largest recieved letter, Uniform to A, makes A 15, which is Oscar.",
        ...
        "*w_342831|Alright, now that I've heard all that...|bbb|rnb|You forgot to keep numbers in the 1-26 range.|Uniform wasn't the largest letter.|Kilo wasn't the only prime letter.",
